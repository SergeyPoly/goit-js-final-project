import{i as C,a as T}from"./vendor-D9ezOI0e.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();function I(e,t){C.show({icon:"fa-solid fa-circle-exclamation",iconColor:"white",message:e,messageColor:"white",position:"topRight",timeout:4e3,color:"#EF4040",maxWidth:"500px"})}function k(e){I(e)}const h="exercise-card",q=10,u=Object.freeze({START:"start",RATE:"rate",REMOVE_FAVORITE:"removeFavorite"}),Y=Object.freeze({LIMITS:{DESKTOP_LARGE:12,DESKTOP:9,EXERCISES_LIST:10},BREAKPOINTS:{DESKTOP_LARGE:1440},DEFAULT_FILTER:"Muscles"});T.defaults.baseURL="https://your-energy.b.goit.study/api";function B(e){k(e.response?.data?.message||`An error occurred: ${e.message}, please try again later!`)}async function b(e,...t){try{const{data:s}=await T[e](...t);return s}catch(s){return B(s),null}}function Z(){return b("get","/quote")}function ee(e,t=1,s=12){return b("get","/filters",{params:{filter:e,page:t,limit:s}})}function te(e,t,s=1,r=q){const{bodypart:o,muscles:i,equipment:n}=e;return b("get","/exercises",{params:{bodypart:o,muscles:i,equipment:n,keyword:t,page:s,limit:r}})}function P(e){return b("get",`/exercises/${e}`)}async function E(e,t){if(e==="open"){const s=N();document.body.classList.add("modal-open"),t.classList.remove("hidden"),t.classList.add("is-open"),document.documentElement.style.setProperty("--scrollbar-width",`${s}px`)}e==="close"&&(t.classList.remove("is-open"),setTimeout(()=>{t.classList.add("hidden"),document.body.classList.remove("modal-open"),document.documentElement.style.removeProperty("--scrollbar-width")},250))}const N=()=>window.innerWidth-document.documentElement.clientWidth;function se(){const e=document.querySelector(".mobile-menu-overlay"),t=document.querySelector(".burger-btn"),s=document.querySelector(".mobile-menu__close-button");e&&t&&s&&(t.addEventListener("click",()=>E("open",e)),s.addEventListener("click",()=>E("close",e)),e.addEventListener("click",({target:i})=>{(i.classList.contains("mobile-menu__nav-link")||i===e)&&E("close",e)}));const r=document.querySelectorAll(".nav-link");let o=window.location.pathname;(o.endsWith("/")||o.endsWith("/index.html"))&&(o="/index.html"),r.forEach(i=>{let n=new URL(i.href).pathname;(n.endsWith("/")||n.endsWith("/index.html"))&&(n="/index.html"),n===o?i.classList.add("active"):i.classList.remove("active")})}const F="/goit-js-final-project/assets/icons-D_oQLUx2.svg";function d(e){return`${F}#${e}`}function W(e,t){return`
  ...
  `;document.querySelector("#exerciseModalBackdrop")?.remove(),document.body.insertAdjacentHTML("beforeend",t);const s=document.getElementById("exerciseModalBackdrop"),r=j();document.body.classList.add("modal-open"),document.documentElement.style.setProperty("--scrollbar-width",`${r}px`),setTimeout(()=>{s.classList.add("is-open")},50);const o=()=>{s.classList.remove("is-open"),setTimeout(()=>{document.body.classList.remove("modal-open"),document.documentElement.style.removeProperty("--scrollbar-width"),s.remove()},300),document.removeEventListener("keydown",i)};s.querySelector(".exercise-modal__close-btn").addEventListener("click",o),s.addEventListener("click",n=>{n.target===s&&o()});function i(n){n.key==="Escape"&&o()}document.addEventListener("keydown",i),s.querySelector(".exercise-modal__buttons").addEventListener("click",n=>{const l=n.target.closest("[data-action]");if(!l)return;const c=l.dataset.action;c==="add"?D(e):c==="remove"&&A(e._id),l.outerHTML=S(e)})}function V(e,t){A(t),H(e,t)}function X(e){console.log(`Rating exercise: ${e}`)}async function z(e){const t=await P(e);K(t)}const f=document.querySelector(".exercises-list-wrapper");function oe(e,t,{favorites:s,onFavoriteDelete:r}={}){f.innerHTML="",s&&f.classList.add("favorites");let o="";e.length?e.forEach(i=>{o+=W(i,s)}):o=`<p class="no-exercises-message">${t}</p>`,f.insertAdjacentHTML("beforeend",o),f.onclick=i=>{let n=i.target;if(n.nodeName!=="BUTTON"&&(n=n.closest(`.${h} button`)),!n||n.nodeName!=="BUTTON")return;const c=n.closest(`.${h}`).dataset.id,m=n.dataset.action;switch(m){case u.REMOVE_FAVORITE:V(f,c),r?.(c);break;case u.START:z(c);break;case u.RATE:X(c);break;default:console.warn("Unknown action:",m)}}}const g=3;function L(){return'<span class="pagination-ellipsis">...</span>'}function J(e,t){return`<button class="page-button ${e===t?"active":""}" data-page="${e}">${e}</button>`}function _(e,t,s,r){return`<button class="page-button arrow ${r?"disabled":""}" data-page="${s}">
    <svg class="pagination-arrow-icon ${t?"double":""}">
      <use href="${d(`pagination-arrow${t?"-double":""}-${e}-icon`)}"></use>
    </svg>
  </button>`}function ie(e,t,s,r=".exercises-list"){let o=document.querySelector(".pagination");o?o.innerHTML="":(o=document.createElement("div"),o.className="pagination",document.querySelector(r).appendChild(o));let i="";const n=Math.max(1,e-Math.floor(g/2)),l=Math.min(t,n+g-1),c=Math.max(1,l-g+1),m=t>g;if(m){const a=e===1;i+=`
      <div class="arrow-buttons">
        ${_("left",!0,1,a)}
        ${_("left",!1,e-1,a)}
      </div>
    `}let p="";for(let a=c;a<=l;a+=1)p+=J(a,e);const M=c>1,O=l<t;if(M&&(p=`${L()}${p}`),O&&(p+=L()),i+=`<div class="page-buttons">${p}</div>`,m){const a=e===t;i+=`
      <div class="arrow-buttons">
        ${_("right",!1,e+1,a)}
        ${_("right",!0,t,a)}
      </div>
    `}o.insertAdjacentHTML("beforeend",i),o.onclick=a=>{const y=a.target.nodeName==="BUTTON"?a.target:a.target.closest(".pagination button");if(y){const $=parseInt(y.dataset.page,10);$!==e&&s($)}}}export{q as E,Y as S,te as a,ie as b,ee as c,x as d,Z as g,se as l,oe as r};
//# sourceMappingURL=pagination-BHhuMvqX.js.map
