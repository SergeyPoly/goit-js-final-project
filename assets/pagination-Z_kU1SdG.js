import{i as W,a as O,E as j}from"./vendor-C1ZlVBJv.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(o){if(o.ep)return;o.ep=!0;const n=s(o);fetch(o.href,n)}})();function k(e,t){W.show({icon:t?"fa-solid fa-circle-exclamation":"fa-solid fa-check",iconColor:"white",message:e,messageColor:"white",position:"topRight",timeout:5e3,color:t?"#EF4040":"#00BFFF",maxWidth:"500px"})}function q(e){k(e,!1)}function U(e){k(e,!0)}const $="exercise-card",z=10,d=Object.freeze({START:"start",RATE:"rate",REMOVE_FAVORITE:"removeFavorite",ADD_FAVORITE:"addFavorite"}),_e=Object.freeze({LIMITS:{DESKTOP_LARGE:12,TABLET:9,EXERCISES_LIST:10},BREAKPOINTS:{DESKTOP_LARGE:1440,TABLET:768},DEFAULT_FILTER:"Muscles"}),I=Object.freeze({FAVORITE_REMOVED:"favorite-removed",FAVORITE_ADDED:"favorite-added"});O.defaults.baseURL="https://your-energy.b.goit.study/api";function G(e){var t,s;U(((s=(t=e.response)==null?void 0:t.data)==null?void 0:s.message)||`An error occurred: ${e.message}, please try again later!`)}async function f(e,...t){try{const{data:s}=await O[e](...t);return s}catch(s){return G(s),null}}function X(){return f("get","/quote")}function ve(e,t=1,s=12){return f("get","/filters",{params:{filter:e,page:t,limit:s}})}function ge(e,t,s=1,a=z){const{bodypart:o,muscles:n,equipment:r}=e;return f("get","/exercises",{params:{bodypart:o,muscles:n,equipment:r,keyword:t,page:s,limit:a}})}function K(e){return f("get",`/exercises/${e}`)}async function Ee(e){const t=await f("post","/subscription",{email:e});return t&&q((t==null?void 0:t.message)||"Thank you for your subscription!"),t}async function J(e,t,s,a){const o=await f("patch",`/exercises/${e}/rating`,{rate:t,email:s,review:a});return o&&q("Thank you for your feedback!"),o}const Y=document.querySelector(".quote-container");function Z(){const e=new Date;return{day:e.getDate(),month:e.getMonth(),year:e.getFullYear()}}function Q(e,t){return!!e&&!!t&&e.day===t.day&&e.month===t.month&&e.year===t.year}function w({author:e,quote:t}){Y.insertAdjacentHTML("beforeend",`
  ...
  `}function C(e){e.querySelector(".exercise-modal__stars").addEventListener("click",t=>{const s=t.target.closest("[data-rating]");if(!s)return;const a=s.dataset.rating|0;e.querySelector(".exercise-modal__rating").outerHTML=B(a),C(e)})}function N(e){var r;const t=`
  ...
  `;(r=document.querySelector("#exerciseModalBackdrop"))==null||r.remove(),document.body.insertAdjacentHTML("beforeend",t);const s=document.getElementById("exerciseModalBackdrop"),a=re();document.body.classList.add("modal-open"),document.documentElement.style.setProperty("--scrollbar-width",`${a}px`),setTimeout(()=>{s.classList.add("is-open")},50);const o=(i=!0)=>{s.classList.remove("is-open"),document.removeEventListener("keydown",n),i&&setTimeout(()=>{document.body.classList.remove("modal-open"),document.documentElement.style.removeProperty("--scrollbar-width")},300),s.remove()};s.querySelector(".exercise-modal__close-btn").addEventListener("click",o),s.addEventListener("click",i=>{i.target===s&&o()});function n(i){i.key==="Escape"&&o()}document.addEventListener("keydown",n),s.querySelector(".exercise-modal__buttons").addEventListener("click",i=>{const l=i.target.closest("[data-action]");if(!l)return;const p=l.dataset.action;switch(p){case d.ADD_FAVORITE:de(e);break;case d.REMOVE_FAVORITE:P(e._id);break;case d.RATE:o(!1),N(e._id);break;default:console.warn("Unknown action:",p)}l.outerHTML=R(e)})}const L=new j;function V(e,t){L.emit(e,t)}function xe(e,t){return L.addListener(e,t),()=>{L.removeListener(e,t)}}function P(e){se(e),V(I.FAVORITE_REMOVED,e)}function de(e){te(e),V(I.FAVORITE_ADDED,e)}function ue(e){N(e)}async function H(e){const t=await K(e);le(t)}function me(e,t){return`
  ...
  `}const v=document.querySelector(".exercises-list-wrapper");function ye(e,t,s){v.innerHTML="",s&&v.classList.add("favorites");let a="";e.length?e.forEach(o=>{a+=me(o,s)}):a=`<p class="no-exercises-message">${t}</p>`,v.insertAdjacentHTML("beforeend",a),v.onclick=o=>{let n=o.target;if(n.nodeName!=="BUTTON"&&(n=n.closest(`.${$} button`)),!n||n.nodeName!=="BUTTON")return;const i=n.closest(`.${$}`).dataset.id,l=n.dataset.action;switch(l){case d.REMOVE_FAVORITE:P(i);break;case d.START:H(i);break;case d.RATE:ue(i);break;default:console.warn("Unknown action:",l)}}}const g=3;function M(){return'<span class="pagination-ellipsis">...</span>'}function pe(e,t){return`<button class="page-button ${e===t?"active":""}" data-page="${e}">${e}</button>`}function E(e,t,s,a){return`<button class="page-button arrow ${a?"disabled":""}" data-page="${s}">
    ...
    `}o.insertAdjacentHTML("beforeend",n),o.onclick=c=>{const x=c.target.nodeName==="BUTTON"?c.target:c.target.closest(".pagination button");if(x){const T=parseInt(x.dataset.page,10);T!==e&&s(T)}}}function Le(){const e=document.querySelector(".pagination");e&&e.remove()}export{I as E,_e as S,$e as a,ve as b,Le as c,be as d,S as e,xe as f,ge as g,z as h,he as l,Ee as p,ye as r};
//# sourceMappingURL=pagination-Z_kU1SdG.js.map
