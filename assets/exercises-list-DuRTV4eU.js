(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const i="exercise-card",a=Object.freeze({START:"start",RATE:"rate",REMOVE_FAVORITE:"removeFavorite"});function u(e,t){return`
  ...
  `}function f(e,t){const s=e.querySelector(`.${i}[data-id="${t}"]`);s&&s.remove()}const l="favoriteExercises";function g(e){const s=v().filter(n=>n._id!==e);p(s)}function p(e){localStorage.setItem(l,JSON.stringify(e))}function v(){try{const e=localStorage.getItem(l);if(e){const t=JSON.parse(e);if(Array.isArray(t))return t.filter(m)}}catch{}return[]}function m(e){return e&&typeof e=="object"&&typeof e._id=="string"&&typeof e.name=="string"}function E(e,t){g(t),f(e,t)}function h(e){console.log(`Rating exercise: ${e}`)}function y(e){console.log(`Starting exercise: ${e}`)}function b(e,t,s){switch(s){case a.REMOVE_FAVORITE:E(e,t);break;case a.START:y(t);break;case a.RATE:h(t);break;default:console.warn("Unknown action:",s)}}const c=document.querySelector(".exercises-list");function x(e,t,s){c.innerHTML="";let n="";e.length?e.forEach(r=>{n+=u(r,s)}):n=`<p class="no-exercises-message">${t}</p>`,c.insertAdjacentHTML("beforeend",n)}c.addEventListener("click",e=>{let t=e.target;if(t.nodeName!=="BUTTON"&&(t=t.closest(`.${i} button`)),!t||t.nodeName!=="BUTTON")return;const n=t.closest(`.${i}`).dataset.id,r=t.dataset.action;b(c,n,r)});export{v as g,x as r};
//# sourceMappingURL=exercises-list-DuRTV4eU.js.map
