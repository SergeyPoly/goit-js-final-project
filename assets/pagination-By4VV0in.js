import{i as C,a as T}from"./vendor-CLZFq-H_.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function s(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=s(o);fetch(o.href,n)}})();function I(e,t){C.show({icon:"fa-solid fa-circle-exclamation",iconColor:"white",message:e,messageColor:"white",position:"topRight",timeout:4e3,color:"#EF4040",maxWidth:"500px"})}function k(e){I(e)}const b="exercise-card",q=10,m=Object.freeze({START:"start",RATE:"rate",REMOVE_FAVORITE:"removeFavorite"}),Y=Object.freeze({LIMITS:{DESKTOP_LARGE:12,DESKTOP:9,EXERCISES_LIST:10},BREAKPOINTS:{DESKTOP_LARGE:1440},DEFAULT_FILTER:"Muscles"});T.defaults.baseURL="https://your-energy.b.goit.study/api";function P(e){var t,s;k(((s=(t=e.response)==null?void 0:t.data)==null?void 0:s.message)||`An error occurred: ${e.message}, please try again later!`)}async function E(e,...t){try{const{data:s}=await T[e](...t);return s}catch(s){return P(s),null}}function Z(){return E("get","/quote")}function ee(e,t=1,s=12){return E("get","/filters",{params:{filter:e,page:t,limit:s}})}function te(e,t,s=1,i=q){const{bodypart:o,muscles:n,equipment:r}=e;return E("get","/exercises",{params:{bodypart:o,muscles:n,equipment:r,keyword:t,page:s,limit:i}})}function B(e){return E("get",`/exercises/${e}`)}async function h(e,t){if(e==="open"){const s=N();document.body.classList.add("modal-open"),t.classList.remove("hidden"),t.classList.add("is-open"),document.documentElement.style.setProperty("--scrollbar-width",`${s}px`)}e==="close"&&(t.classList.remove("is-open"),setTimeout(()=>{t.classList.add("hidden"),document.body.classList.remove("modal-open"),document.documentElement.style.removeProperty("--scrollbar-width")},250))}const N=()=>window.innerWidth-document.documentElement.clientWidth;function se(){const e=document.querySelector(".mobile-menu-overlay"),t=document.querySelector(".burger-btn"),s=document.querySelector(".mobile-menu__close-button");e&&t&&s&&(t.addEventListener("click",()=>h("open",e)),s.addEventListener("click",()=>h("close",e)),e.addEventListener("click",({target:n})=>{(n.classList.contains("mobile-menu__nav-link")||n===e)&&h("close",e)}));const i=document.querySelectorAll(".nav-link"),o=window.location.pathname;i.forEach(n=>{new URL(n.href).pathname===o?n.classList.add("active"):n.classList.remove("active")})}const H="/goit-js-final-project/assets/icons-DcOtptvd.svg";function d(e){return`${H}#${e}`}function j(e,t){return`
  ...
  `}function U(e,t){const s=e.querySelector(`.${b}[data-id="${t}"]`);s&&s.remove()}const w="favoriteExercises";function W(e){const t=x();t.some(s=>s._id===e._id)||(t.push(e),R(t))}function A(e){const s=x().filter(i=>i._id!==e);R(s)}function R(e){localStorage.setItem(w,JSON.stringify(e))}function x(){try{const e=localStorage.getItem(w);if(e){const t=JSON.parse(e);if(Array.isArray(t))return t.filter(F)}}catch{}return[]}function F(e){return e&&typeof e=="object"&&typeof e._id=="string"&&typeof e.name=="string"}const G=()=>window.innerWidth-document.documentElement.clientWidth;function v(e){return e.charAt(0).toUpperCase()+e.slice(1)}function D(e){const t=Math.floor(e);let s="";for(let i=0;i<5;i++){let o=i<t?"star-filled-icon":"star-icon";s+=`
...
//# sourceMappingURL=pagination-By4VV0in.js.map
