import{g as x,l as y,E as f,r as S}from"./assets/header-DgzlJhPB.js";const d=3;function E(){return'<span class="pagination-ellipsis">...</span>'}function L(t,e){return`<button class="page-button ${t===e?"active":""}" data-page="${t}">${t}</button>`}function c(t,e,o,a){return`<button class="page-button arrow ${a?"disabled":""}" data-page="${o}">
